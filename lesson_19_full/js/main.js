window.addEventListener('DOMContentLoaded', () => {
  ...
  const toggleMenu = () => {
    ...
    body.addEventListener('click', (event) => {
      ...
      if(target.classList.contains('.menu')) menu.classList.toggle('active-menu');
      else if(target.classList.contains('close-btn')) menu.classList.toggle('active-menu');
      else if(target.matches('ul>li')) target.preventDefault();
      else if(target.matches('a')) menu.classList.toggle('active-menu');
      else if(!target.matches('menu')) menu.classList.toggle('active-menu');
    });
  };
  toggleMenu();
